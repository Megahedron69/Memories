  ...
  return (
    <body className="leading-normal tracking-normal text-white gradient">
      ...
      <div className="pt-24">
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <Link to="/signup">
              <button className="mx-auto lg:mx-0 hover: bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out cursor-pointer">
                Sign Up
              </button>
            </Link>
          </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 sm:w-1/2 p-6">
              ...
              <p className="text-gray-600 mb-8">
                ...
                <br />
                Images from:
                <a className="text-pink-500 " href="https://undraw.co/">
                  undraw.co
                </a>
              </p>
            </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            ...
            <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div className="flex items-center justify-start">
                <button className="mx-auto lg:mx-0 hover: gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                  Action
                </button>
              </div>
            </div>
      ...
      <section className="container mx-auto text-center py-6 mb-12">
        ...
        <button className="mx-auto lg:mx-0 hover: bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          Action!
        </button>
      </section>
