      ...
      <body class="min-h-screen bg-gray-100 text-gray-900 flex justify-center ">
        <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div class="flex justify-center h-screen">
            <div
              class="hidden bg-cover lg:block lg:w-2/3 gradient"
            ...
            >
              <svg
                ...
                width="943.00108"
                height="795.62948"
                viewBox="0 0 943.00108 795.62948"
              ...
              >
                ...
                <path
                  ...
                  fill="#ccc"
                ></path>
                <rect x="217" y="177" width="329" height="6" fill="#ccc"></rect>
                <rect x="217" y="277" width="329" height="6" fill="#ccc"></rect>
                <rect
                  x="317.76367"
                  y="89"
                  width="6"
            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
              <div class="flex-1">
                ...
                <div className="mt-9">
                  <h3 className="justify-between text-center font-bold text-slate-400 text-5xl ">
                    OR
                  </h3>
                </div>
                <div class="mt-8">
                  <form onSubmit={handlesubmit}>
                    ...
                    <div class="mt-6">
                      <button
                        type="submit"
                        class="w-full max-w-xl font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline gradient"
                        onClick={signin}
                      >
                        Sign in
                      </button>
